...
### Problemas inseridos e tratados

| Problema | Como foi inserido | Solução em SQL |
|---|---|---|
| Duplicatas | cópia de entre 3% das linhas | padronizar antes, depois `ROW_NUMBER()` |
...
| Valores negativos | sinal trocado em entre 8% de `transaction_amount` | `ABS()` |
| Typo "Wellcome" | Welcome escrito errado de propósito | `REPLACE()` |

### As três coisas que eu aprendi
